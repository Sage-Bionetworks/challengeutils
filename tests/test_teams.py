...
class TestTeam:
    ...
    def test__get_team_count_rest(self):
        ...
        with patch.object(
            self.syn, "restGET", return_value=self.return_count
        ) as rest_get:
    ...
    def test_get_team_count(self):
        ...
        with patch.object(
            self.syn, "getTeam", return_value=fake_team
        ) as get_team, patch.object(
            teams, "_get_team_count", return_value=self.return_count
        ) as get_count:
...
class TestTeamDiff:
    ...
    def test__get_team_set(self):
        ...
        with mock.patch.object(
            self.syn, "getTeamMembers", return_value=self.members1
        ) as patch_get:
    ...
    def test_team_members_diff(self):
        ...
        assert teams.team_members_diff(self.syn, 1, 2) == {
            self.member4,
            self.member3,
        }
    ...
    def test_team_members_intersection(self):
        ...
        assert teams.team_members_intersection(self.syn, 1, 2) == {
            self.member1,
            self.member2,
        }
    ...
    def test_team_members_union(self):
        ...
        assert teams.team_members_union(self.syn, 1, 2) == {
            self.member1,
            self.member2,
            self.member3,
            self.member4,
