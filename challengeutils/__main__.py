...
def build_parser():
    ...
    parser_validate_wiki_config = subparsers.add_parser(
        'validate-wiki-config',
        help='Validate a wiki configuration generated by pull-wiki.')
    parser_validate_wiki_config.add_argument(
        "workdir", type=str,
        help='Path to markdown files and wiki_config.json.'
    )
    parser_validate_wiki_config.set_defaults(
        func=command_validate_wiki_config
    )
