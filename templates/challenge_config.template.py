...
class Validate(EvaluationQueueValidator):
    ...
    def interaction_func(self, submission, goldstandard_path):
        assert (
            submission.filePath is not None
...
class Score(EvaluationQueueScorer):
    ...
    def interaction_func(self, submission, goldstandard_path):
        ...
        score_status = {"valid": True, "annotations": score_dict, "message": message}
        return score_status
    ...
    def interaction_func(self, submission, public=True, admin=None):
        ...
        try:
            if public:
                ...
                ent = self.syn.getPermissions(
                    submission["entityId"], AUTHENTICATED_USERS
                )
            ...
            if admin is not None:
                message = (
                    f"Please share your private directory ({submission['entityId']})"
            ...
            raise syn_error
        validation_status = {"valid": True, "annotations": {}, "message": "Validated!"}
...
class ArchiveProject(EvaluationQueueScorer):
    ...
    def interaction_func(self, submission, admin):
        ...
        permissions.set_entity_permissions(self.syn, new_project_entity, admin, "admin")

        synapseutils.copy(self.syn, submission.entityId, new_project_entity.id)
...
EVALUATION_QUEUES_CONFIG = [
    {"id": 1, "func": Validate, "kwargs": {"goldstandard_path": "path/to/sc1gold.txt"}},
    {"id": 1, "func": Score, "kwargs": {"goldstandard_path": "path/to/sc1gold.txt"}},
    {"id": 2, "func": ValidateProject, "kwargs": {"public": True, "admin": "foo"}},
    {"id": 2, "func": ArchiveProject, "kwargs": {"admin": "foo"}},
]
