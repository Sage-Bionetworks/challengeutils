...
class DiscussionApi:
    ...
    def get_forum_threads(
        self, forumid: str, query_filter: str = "EXCLUDE_DELETED", **kwargs
    ) -> Iterator[Thread]:
    ...
    def post_thread(self, forumid: str, title: str, message: str) -> Thread:
        ...
        thread = self.syn.restPOST("/thread", body=json.dumps(request_obj))
        return Thread(**thread)

    def get_threads_referencing_entity(
        self, entityid: str, **kwargs
    ) -> Iterator[Thread]:
        """
        ...
        """
        threads = self.syn._GET_paginated(
            f"/entity/{entityid}/threads", **kwargs
        )
        for thread in threads:
            yield Thread(**thread)
    ...
    def post_reply(self, threadid: str, message: str) -> Reply:
        ...
        return Reply(
            **self.syn.restPOST("/reply", body=json.dumps(create_reply))
        )
    ...
    def get_thread_replies(
        self, threadid: str, query_filter: str = "EXCLUDE_DELETED", **kwargs
    ):
    ...
    def get_forum_threadcount(
        self, forumid: str, query_filter: str = "EXCLUDE_DELETED"
    ) -> int:
    ...
    def get_thread_replycount(
        self, threadid: str, query_filter: str = "EXCLUDE_DELETED"
    ) -> int:
    ...
    def get_threadcount_referencing_entities(
        self, entityid_list: list
    ) -> list:
        ...
        return self.syn.restPOST(
            "/entity/threadcounts", body=json.dumps(entities)
        )


def get_forum_threads(
    syn: Synapse, ent: Union[Project, str], **kwargs
) -> Iterator[Thread]:
    """
...
def get_thread_replies(
    syn: Synapse, thread: Thread, **kwargs
) -> Iterator[Reply]:
...
def get_forum_participants(
    syn: Synapse, ent: Union[Project, str]
) -> List[UserProfile]:
    """
...
def copy_thread(
    syn: Synapse, thread: Thread, project: Union[Project, str]
) -> Thread:
