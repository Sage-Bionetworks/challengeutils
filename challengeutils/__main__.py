...
def build_parser():
    ...
    # parser.add_argument(
    #     '-u', '--username', dest='synapseUser',
    #     help='Username used to connect to Synapse')
    # parser.add_argument(
    #     '-p', '--password', dest='synapsePassword',
    #     help='Password used to connect to Synapse')
    # parser.add_argument(
    #     '-c', '--configPath', dest='configPath',
    #     default=synapseclient.client.CONFIG_FILE,
    #     help='Path to configuration file used to connect '
    #          'to Synapse [default: %(default)s]')
    ...
    parser_mirrorWiki = subparsers.add_parser(
        ...
        help="This command mirrors wiki pages. It relies on the wiki titles "
             "between two Synapse Projects to be the same and will merge "
             "the updates from entity's wikis to destination's wikis.  "
    ...
    parser_attach_writeup = subparsers.add_parser(
        'attachwriteup',
        help='Attaches the write ups of a challenge '
             'to its main challenge queue')
