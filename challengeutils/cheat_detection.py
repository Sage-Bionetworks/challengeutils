...
Potentially Linked Users: {self.get_number_of_linked_users()}
    ...
    def get_evaluation_rounds(self):
        ...
        if len(round_list) == 0:
            ...
            if quota:
                raise Exception("UNABLE TO SCAN: Evaluation is using the DEPRECIATED submission quota method.")
            else:
                raise Exception("UNABLE TO SCAN: Unable to identify evaluation rounds or submission quotas")
